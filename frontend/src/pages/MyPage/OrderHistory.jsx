...
// OrderHistory.jsx 수정 부분
import OrderContentCard from "../../component/OrderContentCard.jsx";
...
const OrderHistory = () => {
    ...
    // 예시 주문 데이터 (실제 API 연동 가능)
    const orders = [
        {
            id: 1,
            orderDate: "25.03.26",
            productName: "Stealth XPAC™ Deluxe Chalk Bucket: Mag Closure",
            productImage: "public/imgs/shop/bag1-5.jpg",
            quantity: 1,
            size: "FREE",
            color: "GRAY",
            price: 48500
                ...
                {orderTab === "order" ? (
                    <div className="order-Content">
                        ...
                        {orders.length > 0 ? (
                            ...
                            <div className="OrderContent-empty">
                                <img src="/icons/mypage-noneIcon.svg" alt="noneIcon" />
                                <h2>주문 내역이 없습니다.</h2>
                            </div>
                        )}
                    </div>
